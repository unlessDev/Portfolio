import profilepic from "../assets/unlessDev.jpeg"
            ...
            <div className="flex flex-wrap">
                <div className="w-full lg:w-1/2">
                    <div className="flex flex-col items-center lg:items-start">
                        <h1 className="pb-16 text-6xl lg:mt-16 font-semibold lg:text-9xl">unlessDev</h1>
                        <span className="bg-gradient-to-r from-blue-600 via-slate-300 to-purple-400 bg-clip-text text-4xl text-transparent">
